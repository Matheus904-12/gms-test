...
describe('US-012-Funcionalidade: Cadastro de Usuário', () => {
  it('Deve fazer o cadastro de campos obrigatórios', () => {
    ...
    // Intercepta a requisição de cadastro para ver o erro
    cy.intercept('POST', '**/cadastro').as('cadastroRequest')
    ...
    // Aguarda a requisição e verifica a resposta
    ...
    // Aguarda a resposta aparecer no DOM e verifica o conteúdo
    cy.get('#signup-response', { timeout: 10000 }).should('not.be.empty').then(($el) => {
      console.log('Response text:', $el.text())
    })
    
    // Verifica se é sucesso ou se há erro específico
